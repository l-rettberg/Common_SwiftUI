//
//  QRCodeGenerator+Logo+Gradient.swift
//  CommonSwiftUI
//
...
extension QRCodeGenerator {
    ...
    /// Generates a QR code with a gradient fill from a string.
    ///
    /// - Parameters:
    ...
    /// Generates a gradient-filled QR code from a string and throws on failure.
    /// - Parameters:
    ///   - string: The string to encode in the QR code.
    ///   - size: The desired size of the output image.
    ///   - gradientColors: Array of colors to create the gradient.
    ...
    /// Generates a gradient-filled QR code from a URL.
    /// - Parameters:
    ...
    /// Generates a gradient-filled QR code from a URL and throws on failure.
    /// - Parameters:
    ///   - url: The `URL` to encode in the QR code.
    ///   - size: The desired size of the output image.
    ///   - gradientColors: Array of colors to create the gradient.
    ...
    /// Generates a gradient-filled QR code from binary data.
    /// - Parameters:
    ...
    public static func generateQRCode(
        ...
        return generateQRCodeInternalWithLogoGradient(
            from: data,
            size: size,
            gradientColors: gradientColors,
            gradientDirection: gradientDirection,
    ...
    /// Generates a gradient-filled QR code from binary data and throws on failure.
    /// - Parameters:
    ///   - data: Binary data to encode in the QR code.
    ///   - size: The desired size of the output image.
    ///   - gradientColors: Array of colors to create the gradient.
    ...
    public static func generateQRCode(
        ...
        return try generateQRCodeInternalWithLogoGradientThrowing(
            from: data,
            size: size,
            gradientColors: gradientColors,
            gradientDirection: gradientDirection,
    ...
    private static func generateQRCodeInternalWithLogoGradient(
        from data: Data,
        size: CGSize,
    ...
    private static func generateQRCodeInternalWithLogoGradientThrowing(
        from data: Data,
        size: CGSize,
        gradientColors: [UIColor],
        gradientDirection: GradientDirection,
