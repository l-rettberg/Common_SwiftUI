//
//  QRCodeGenerator+Logo+Crystallize.swift
//  CommonSwiftUI
//
...
extension QRCodeGenerator {
    ...
    /// Generates a vintage-style QR code image from a given string, with options for colors and embedding a logo.
    ///
    /// - Parameters:
    ...
    /// Generates a vintage-style QR code image from a given URL, with options for colors and embedding a logo.
    ///
    /// - Parameters:
    ...
    /// Generates a vintage-style QR code image from binary data, with options for colors and embedding a logo.
    ///
    /// - Parameters:
    ...
    public static func generateVintageQRCode(
        ...
        return generateCrystallizeQRCodeInternalWithLogo(
            from: data,
            size: size,
            color: color,
            backgroundColor: backgroundColor,
    ...
    public static func generateVintageQRCode(
        ...
        return try generateCrystallizeQRCodeInternalWithLogoThrowing(
            from: data,
            size: size,
            color: color,
            backgroundColor: backgroundColor,
    ...
    private static func generateCrystallizeQRCodeInternalWithLogo(
        from data: Data,
        size: CGSize,
        color: UIColor = .black,
    ...
    private static func generateCrystallizeQRCodeInternalWithLogoThrowing(
        from data: Data,
        size: CGSize,
        color: UIColor,
        backgroundColor: UIColor,
